...
import CardCat from '@/components/dashboard/CardCat.vue';
import DialogCard from '@/components/dashboard/DialogCard.vue';
import AdminLayout from '@/layout/AdminLayout.vue';
import CardNew from '@/components/dashboard/CardNew.vue';
interface Props {
    cards: CardType[];
}
